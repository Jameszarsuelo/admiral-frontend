...
const FileInput: FC<FileInputProps> = ({ className, onChange }) => {
  return (
    <input
      ...
      // Important: allow re-selecting the same filename (common when user edits the CSV in-place).
      // Without clearing, many browsers won't fire onChange when the same file is picked again.
      onClick={(e) => {
